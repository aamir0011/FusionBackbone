...
## 12) Cross-branch sequential rerun status

Comprehensive one-by-one GPU reruns for approach branches are tracked in:
- `experiments/rerun_all_branches_all_datasets.csv`

## 13) Full-scale cross-branch run status

Full sequential GPU runs (all approaches x all datasets) are tracked in:
- `experiments/fullscale_all_branches_all_datasets.csv`
- `experiments/fullscale_modality_ablation_all_datasets.csv`
